...
public final class  ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =  -2562.9726373851204; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2326.8068126061034; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2129.294646268101; // x position of the perpendicular encoder (in tick units)
    }

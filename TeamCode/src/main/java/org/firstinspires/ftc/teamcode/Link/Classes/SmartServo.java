...
public class SmartServo {
    ...
    static  void init() {
        if(!isInitialized) {
            ...
            constraintsForEachServo.put("wristLeft", new SingleServoConstraints(0.49, 0.51));
            constraintsForEachServo.put("wristRight", new SingleServoConstraints(0.49, 0.51));
            constraintsForEachServo.put("claw", new SingleServoConstraints(0.49, 0.51));
        }
    }

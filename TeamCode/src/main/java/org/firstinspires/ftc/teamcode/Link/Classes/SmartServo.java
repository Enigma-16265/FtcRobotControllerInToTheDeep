...
public class SmartServo {
    ...
    static  void init() {
        if(!isInitialized) {
            ...
            constraintsForEachServo.put("outtakeLeft", new SingleServoConstraints(0.07, 0.9478)); //Arm btw
            constraintsForEachServo.put("outtakeRight", new SingleServoConstraints(0.07, 0.9478)); //Init .51
